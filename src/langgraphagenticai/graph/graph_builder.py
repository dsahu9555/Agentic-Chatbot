...
class GraphBuilder:
    ...
    def chatbot_with_tools_build_graph(self):
        ...
        and a tool node. It defines tools, initializes that chatbot with tool
        capabilities, and sets up conditional and direct edges between nodes.
        That chatbot node is set as the entry point.
        """
        ...
        # self.graph_builder.add_edge("chatbot", END) # tool will automatically handle this
